...
class LocalPlanner(object):
    ...
    def __init__(self, vehicle, opt_dict={}, map_inst=None):
        ...
        self._args_lateral_dict = {'K_P': 1.95, 'K_I': 0.05, 'K_D': 0.2, 'dt': self._dt}#{'K_P': 1.95, 'K_I': 0.05, 'K_D': 0.2, 'dt': self._dt}
        self._args_longitudinal_dict = {'K_P': 1.0, 'K_I': 0.05, 'K_D': 0, 'dt': self._dt}
        self._max_throt = 1#0.75
        self._max_brake = 1#0.3
        self._max_steer = 1#0.8
        self._offset = 0
    ...
    def run_step(self, debug=False):
        ...
        #print(get_speed(self._vehicle) / 3.6)
        #print(self._vehicle.get_speed_limit())
        #print("\n")
